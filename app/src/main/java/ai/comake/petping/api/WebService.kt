...
interface WebService {
     ...
     */
    @GET("/v2/sapa/home/app-update-version")
    ...
    @POST("/v2/shop/petping/members/{memberId}")
     ...
     * 산책종료
     */
    @PUT("/v2/petping/walks/{walkId}/finish")
     ...
     * 산책종료
     */
    @PUT("/v2/sapa/walks/{walkId}/finish")
     ...
     */
    @Multipart
    @POST("/v2/petping/walks/{walkId}/end/comment")
    ...
    @POST("/v2/petping/walks/{walkId}/marking")
     ...
     * 장소 리스트 가져오기
     */
    @GET("/v2/petping/poi/places")
    suspend fun placePoiList(
        @Header("Authorization") authKey: String,
        @Query("lat") lat: String,
        @Query("lng") lng: String
    ): CommonListResponse<PlacePoi>

    /**
     * 마킹 리스트 가져오기
     */
    @GET("/v2/petping/poi/markings")
     ...
     * 마킹 상세 가져오기
     */
    @GET("/v2/petping/walks/marking/{markingId}")
     ...
     * 플레이스 상세 가져오기
     */
    @GET("/v2/petping/walks/place/{placeId}")
     ...
     * @return
     */
    @GET("/v2/petping/rewards/{member_id}/detail-pings")
     ...
     * @return
     */
    @GET("/v2/petping/rewards/{member_id}/available-pings")
    ...
    @GET("/v2/petping/rewards/{member_id}/history/saving-use-pings")
    ...
    @GET("/v2/petping/rewards/{member_id}/history/expiration-pings")
    ...
    @GET("/v2/petping/rewards/{member_id}/ongoing-missions")
    ...
    @GET("/v2/petping/rewards/{member_id}/completion-missions")
    ...
    @Multipart
    @POST("/v2/petping/rewards/file-upload")
     ...
     * @return
     */
    @GET("/v2/petping/my-pages/representativeMissionPet")
     ...
     * @return
     */
    @GET("/v2/petping/my-pages/petInsuranceMissionPet")
     ...
     * @return
     */
    @GET("/v2/petping/my-pages/candidateRepreMisPets")
     ...
     * @return
     */
    @POST("/v2/petping/my-pages/representativeMissionPet")
    suspend fun setRepresentativeMissionPet(
        @Header("Authorization") authKey: String,
        @Body body: RequestBody
    ): CommonResponse<Any>

    @GET("/v2/petping/my-pages")
    suspend fun getMyPageInfo(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): CommonResponse<MyPageData>

    @GET("/v2/petping/my-pages/notices")
    suspend fun getNoticeList(
        @Header("Authorization") authKey: String
    ): CommonResponse<List<NoticeResponseData>>

    //[더보기/반려견] 회원 정보 조회
    @GET("/v2/petping/members/{memberId}")
    suspend fun getMemberInfo(
        @Header("Authorization") authKey: String,
        @Path("memberId") memberId: String
    ): CommonResponse<MemberInfo>

    @POST("/v2/petping/auth-email/send")
    suspend fun sendAuthEmail(
        @Header("Authorization") authKey: String,
        @Body body: RequestBody
    ): CommonResponse<Any>

    @GET("/v2/petping/my-pages/faqs")
    suspend fun getFaqList(
        @Header("Authorization") authKey: String
    ): CommonResponse<List<NoticeResponseData>>

    @GET("/v2/petping/my-pages/personalInquirys")
    suspend fun getInquirys(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): CommonListResponse<InquiryData>

    @GET("/v2/petping/appInfos")
    suspend fun getAppInfo(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): CommonResponse<AppInfo>

    @GET("/v2/petping/my-pages/notification-receiving-statuses/")
    ...
    //마케팅 수신 알람 수정
    @PUT("/v2/petping/members/{memberId}")
    ...
    @PUT("/v2/petping/my-pages/notification-receiving-statuses/{type}")
    ...
    @GET("/v2/petping/my-pages/applicable-welcome-kit")
    suspend fun getWelcomeKitApply(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): CommonResponse<WelcomeKit>

    @GET("/v2/petping/pets/{petId}/profiles")
    ...
    @GET("/v2/petping/pets/{petId}/walk-record")
    ...
    @DELETE("/v2/petping/walks/{walkId}/records")
    suspend fun deleteWalkRecord(
        @Header("Authorization") authKey: String,
        @Path("walkId") id: Int
    ): CommonResponse<Any>

    @GET(" /v2/petping/pets/{petId}/walking-stats")
    ...
    // 이메일 중복
    @GET("/v2/sapa/accounts/email/duplication-chk")
    ...
    @POST("/v2/sapa/accounts/password/find")
    ...
    //본인 인증된 데이터를 서버에 전달
    @POST("/v2/petping/validation")
    suspend fun setMemberValidation(
        @Header("Authorization") authKey: String,
        @Body body: RequestBody
    ): CommonResponse<Any>

    @GET("/v2/petping/my-pages/leaveReasons")
    ...
    @GET("/v2/petping/members/{memberId}/location-information")
    ...
    @GET("/v2/petping/my-pages/petInsurJoins")
    suspend fun getPetInsurJoins(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): CommonListResponse<PetInsurJoinsData>

    @GET("/v2/petping/my-pages/candidateInsurConnectPets")
     ...
     * @return
     */
    @GET("/v2/petping/my-pages/petInsurAvailableCheck")
    suspend fun getPetInsuranceCheck(
        @Header("Authorization") authKey: String,
        @Query("memberId") memberId: String
    ): PetInsuranceCheckResponse

    @POST("/v2/petping/my-pages/petInsurConnection")
    suspend fun connectPetInsurance(
        @Header("Authorization") authKey: String,
        @Body body: RequestBody
    ): CommonResponse<Any>

    @GET("/v2/petping/validation-ci")
     ...
     * @return
     */
    @PUT("/v2/petping/pet-profiles/{targetProfileId}/family-disconnect")
    ...
    @PUT("/v2/petping/pet-characters/{petCharId}")
    ...
    @Multipart
    @PUT("/v2/petping/pet-profiles/{profileId}")
    ...
    @GET("/v2/petping/breeds")
    suspend fun getBreedList(
        @Header("Authorization") authKey: String
    ): CommonResponse<Breed>

    @DELETE("/v2/petping/pet-profiles/{profileId}")
    suspend fun deletePetProfile(
        @Header("Authorization") authKey: String,
        @Path("profileId") profileId: Int
    ): CommonResponse<Any>

    @GET("/v2/petping/home/dashboard")
...
//    ): ProfileResponse
    ...
    @GET("/v2/petping/home/pingzone-meet-pets")
    suspend fun getPingZoneFriends(
        @Header("Authorization") authKey: String,
        @Query("petId") petId: Int
    ): PingZoneResponse

    @GET("/v2/petping/my-pages/personalInquiryTypes")
    suspend fun getInquiryType(
        @Header("Authorization") authKey: String
    ): CommonListResponse<InquiryType>

    @Multipart
    @POST("/v2/petping/my-pages/personalInquirys")
    ...
    @GET("/v2/petping/my-pages/newAlertInfos")
